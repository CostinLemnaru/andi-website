...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Sections: Schema.Attribute.Component<'navigation.section', true>;
...
export interface ApiPageCategoryPageCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Components: Schema.Attribute.DynamicZone<
      [
        ...
        'page.sitemap-resources',
        'page.knowledge-pack-tabs',
        'page.card-with-tags',
        'page.card-simple',
        'page.card-resources',
        'page.card-nested',
        'page.card-list',
        'page.card-code-block',
        'page.card-button-and-toggle-preview',
        'page.card-2-columns',
        'page.ai-policy-tabs',
        'posts.title',
        'posts.tabs-icons',
