...
export default function ComingSoon({ data }: Props) {
  ...
  const heroData = components.find((comp: any) => comp.__component === "hero.hero-section")
            ...
            <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0 px-4 sm:px-6 md:pl-12 lg:pl-16 md:pr-0 z-10">
              ...
              <div className="mb-8 flex flex-col items-center md:items-start">
                <div className="mb-1 text-4xl sm:text-5xl md:text-6xl">
                  <span className="text-gray-400">{heroData.Title?.prefix} </span>
                  <GradientText>{heroData.Title?.highlight}</GradientText>
                </div>
              ...
              <div className="mb-12">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-light mb-4 text-gray-400">
                  <div className="mb-3">
                    {heroData.Description?.tagline_plain}{" "}
                    <ActionWords words={heroData.Description?.action_words ?? []} />
                  </div>
              ...
              <form onSubmit={handleEmailSubmit} className="w-full max-w-md mb-16">
                <div className="flex flex-col gap-4 sm:flex-row">
                  ...
                  >
                    {heroData.CtaText ?? "Get Early Access"}
                  </Button>
                </div>
              </form>
            </div>
